...
@pytest.mark.asyncio
async def test_reject_duplicate_active_loan(
        async_client,
        test_user,
        test_admin,
        sample_book,
...
async def test_return_loan(
    ...
    return_response = await async_client.patch(
    ...
    assert return_data["returned_date"] is not None
...
@pytest.mark.asyncio
async def test_reject_double_return(
        async_client,
        test_user,
        test_admin,
        sample_book,
    ...
    second_return_response = await async_client.patch(
        f"/loans/{loan_id}/return",
        headers=headers
    )
